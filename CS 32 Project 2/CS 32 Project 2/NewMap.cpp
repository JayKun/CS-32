...
{
	list = new Data[DEFAULT_MAX_ITEMS]; 
	for (int i = 0; i < DEFAULT_MAX_ITEMS; i++)
	{
		list[i].is_empty = true;
	}
	m_n = DEFAULT_MAX_ITEMS;
}
...
void Map::dump() const
{
	...
	{
		cerr << "Key is " << list[i].KeyData << endl;
		cerr << "Value is " << list[i].ValueData << endl;
	}
}